...
def ParseArgs():
	...
	parser.add_argument('--model', default='fairdgcl', type=str, help='model')
	...
	parser.add_argument('--adtau', default=0.1, type=float, help='adding tau in camus/fairdrop')
	parser.add_argument('--gnn_layer', default=2, type=int, help='number of gnn layers')
	parser.add_argument('--data', default='ml_100k', type=str, help='name of dataset')
	parser.add_argument('--output_dir', default='out/ml_100k3', type=str, help='name of file name')
	parser.add_argument('--ssl_reg', default=0.1, type=float, help='weight for contrative learning')
	parser.add_argument("--ib_reg", type=float, default=0.01, help='weight for information bottleneck')
	parser.add_argument("--adv_reg", type=float, default=0.01, help='weight for adversary')
	...
	parser.add_argument('--lambda0', type=float, default=0, help='weight for L0 loss on laplacian matrix.')
